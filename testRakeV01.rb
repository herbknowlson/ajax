...
#SERVER_URL
#it 'step-01 should test rake' do
#  response = RestClient.get("#{SERVER_URL}/patientlist", :x_auth_token => @xAuthToken, :params => {:listtype => 'Census', :moduleId => PM_MODULE_ID, :siteId => SITEID}){|response, request, result|
